 ...
 * Use the [PaymentConfirmationFragment.newInstance] factory method to
...
class PaymentConfirmationFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment PaymentConfirmationFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
                PaymentConfirmationFragment().apply {
